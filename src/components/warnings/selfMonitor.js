...
export const SelfMonitor = () => (
  <div key="SelfMoniror" className="card">
    ...
    <p>
      However, there’s a chance you could get sick since it’s less than 14 days
      since your exposure. You should self-monitor for any symptoms (fever,
      cough, sneezing, or sore throat).
    </p>
    <p>
      If you begin to develop symptoms (fever, cough, sneezing, or sore throat),
      you should
      <a
