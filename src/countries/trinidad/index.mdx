  ...
  <div className="card">
    <div className="card__info">
      <p>
        ...
        hotlines for questions and concerns. These hotlines are staffed by a team of medical professionals and are available 24/7.
        <br />
      ...
      <p>
        For questions and concerns, the Trinidad and Tobago Ministry of
